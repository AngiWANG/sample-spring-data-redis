package com.allinpay.its.sample.spring.data.redis.jedis;
...
/**
 * Created by angi on 17-5-17.
 */
public class TestNormalMain {
    public static void main(String[] args){
            ConfigurableApplicationContext ctx = null;
            try {
                ctx = new ClassPathXmlApplicationContext("classpath*:spring/jedis-normal.xml");
